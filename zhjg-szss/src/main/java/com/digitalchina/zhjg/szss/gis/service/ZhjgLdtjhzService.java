 ...
 */
public interface ZhjgLdtjhzService extends IService<T> {
     ...
     * @return
     */
    List<Map<String, String>> selectZhjgLdLxSzNum(Integer ldlxid);

    /**
     * 分析评价-统计汇总-各区域绿地树种统计
     * @return
     */
    List<Map<String, String>> selectZhjgGqyLdSzTj(Integer ldlxid);
