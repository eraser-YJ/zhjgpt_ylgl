...
public class MidGeneratorServiceEntity {
	...
	private static final String OUTPUT_DIR = "D:\\project\\city-manage-mid\\trunk\\modules\\src\\main\\java";
	private static final String PACKAGE_NAME = "com.digitalchina.modules";
	...
	public void generateCode() throws IOException {
		generateByTables(false, "sys_dict", "sys_dict_item");
	}
	...
	private void generateByTables(boolean serviceNameStartWithI, String... tableNames) throws IOException {
		...
		strategyConfig.setCapitalMode(true).setEntityLombokModel(false).setNaming(NamingStrategy.underline_to_camel)
				...
				.setRestControllerStyle(true).setEntityLombokModel(true).setEntityBuilderModel(true);
