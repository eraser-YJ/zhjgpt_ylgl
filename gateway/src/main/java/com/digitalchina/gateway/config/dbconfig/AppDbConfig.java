...
@MapperScan(basePackages = { "com.digitalchina.gateway.app.mapper*" }, sqlSessionTemplateRef = "gisSqlSessionTemplate")
public class AppDbConfig {
    ...
    public SqlSessionFactory getSqlSessionFactory(@Qualifier("appDatasource") DataSource dataSource,
        ...
        sqlSessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath*:com/digitalchina/gateway/app/mapper/xml/*Mapper.xml"));
        return sqlSessionFactory.getObject();
    }

    // 配置事务管理器
    @Bean(name = TransConstant.GIS_TRANSACTION_MANAGER)
    public DataSourceTransactionManager getTransactionManager(@Qualifier("appDatasource") DataSource dataSource) {
