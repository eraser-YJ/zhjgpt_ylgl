...
public class JsonMapper extends ObjectMapper {
	 ...
	 */
	public static <T> T fromJsonString(String jsonString, Class<T> clazz, Class<?> elementClass)
			throws JsonParseException, JsonMappingException, IOException {
		final ObjectMapper mapper = new ObjectMapper();
		JavaType collectionType = getCollectionType(mapper, clazz, elementClass);
