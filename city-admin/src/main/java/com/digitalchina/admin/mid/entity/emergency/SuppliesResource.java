 ...
 * @since 2019-12-06
 */
@TableName("emergency.supplies_resource")
@ApiModel(value="SuppliesResource对象", description="应急救援物资管理")
public class SuppliesResource implements Serializable {

    private static final long serialVersionUID = 1L;

    private Integer id;

    @ApiModelProperty(value = "应急救援物资名称")
    private String name;
