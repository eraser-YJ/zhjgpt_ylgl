 ...
 * @since 2019-12-06
 */
@TableName("emergency.experts_resource")
@ApiModel(value="ExpertsResource对象", description="专家资料管理")
public class ExpertsResource implements Serializable {
