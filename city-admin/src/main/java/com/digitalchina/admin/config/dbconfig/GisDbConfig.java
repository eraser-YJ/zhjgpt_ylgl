...
@MapperScan(basePackages = { "com.digitalchina.admin.gis.mapper*" }, sqlSessionTemplateRef = "gisSqlSessionTemplate")
public class GisDbConfig {
	...
	public SqlSessionFactory getSqlSessionFactory(@Qualifier("gisDatasource") DataSource dataSource,
		...
		sqlSessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
				.getResources("classpath*:com/digitalchina/admin/gis/mapper/xml/*Mapper.xml"));
