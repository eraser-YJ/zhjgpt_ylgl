...
public class MidGeneratorServiceEntity {
	...
	private static final String OUTPUT_DIR = "D:\\codeGen\\city-event-zhjg\\src\\main\\java";
	...
	private static final String TABLE_PREFIX = "warn_";
	 private static final String SCHEMA_NAME = "public";
//	private static final String SCHEMA_NAME = null;

	@Test
	public void generateCode() {
		generateByTables(false, "busievent","bestep","bedept","besum","befrom","betype","workflow","admdiv");
	}
...
//		deleteEntity("sysOrg");
	...
	private void generateByTables(boolean serviceNameStartWithI, String... tableNames) {
		...
		dataSourceConfig.setDbType(DbType.POSTGRE_SQL).setUrl(DB_URL).setSchemaName(SCHEMA_NAME).setUsername(DB_USER_NAME).setPassword(DB_PASSWORD).setDriverName(DB_DRIVER);
